...
<h1>Australian Cuisine Recipes</h1>
<style>
        h1 {
                    text-align: center;
                    color: orange;
...
<?php
$result = $conn->query("SELECT * FROM recipes_home WHERE cuisine_type='australian' ORDER BY id DESC");
...
if ($result->num_rows > 0) {
    ...
    echo "No Australian recipes found.";
}
?>
</div>
<script src="https:
